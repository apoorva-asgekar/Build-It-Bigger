...
public class MyApi extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
   ...
   * @since 1.7
   */
  public static final String DEFAULT_ROOT_URL = "https://jokemobilebackend.appspot.com/_ah/api/";
  ...
  /**
   * Create a request for the method "makeMeLaugh".
   *
   * This request holds the parameters needed by the myApi server.  After setting any optional
   * parameters, call the {@link MakeMeLaugh#execute()} method to invoke the remote operation.
   *
   * @return the request
   */
  public MakeMeLaugh makeMeLaugh() throws java.io.IOException {
    MakeMeLaugh result = new MakeMeLaugh();
    initialize(result);
    return result;
  }

  public class MakeMeLaugh extends MyApiRequest<com.udacity.gradle.builditbigger.backend.myApi.model.MyBean> {

    private static final String REST_PATH = "makeMeLaugh";

    /**
     * Create a request for the method "makeMeLaugh".
     *
     * This request holds the parameters needed by the the myApi server.  After setting any optional
     * parameters, call the {@link MakeMeLaugh#execute()} method to invoke the remote operation. <p>
     * {@link
     * MakeMeLaugh#initialize(com.google.api.client.googleapis.services.AbstractGoogleClientRequest)}
     * must be called to initialize this instance immediately after invoking the constructor. </p>
     *
     * @since 1.13
     */
    protected MakeMeLaugh() {
      super(MyApi.this, "POST", REST_PATH, null, com.udacity.gradle.builditbigger.backend.myApi.model.MyBean.class);
    }

    @Override
    public MakeMeLaugh setAlt(java.lang.String alt) {
      return (MakeMeLaugh) super.setAlt(alt);
    }

    @Override
    public MakeMeLaugh setFields(java.lang.String fields) {
      return (MakeMeLaugh) super.setFields(fields);
    }

    @Override
    public MakeMeLaugh setKey(java.lang.String key) {
      return (MakeMeLaugh) super.setKey(key);
    }

    @Override
    public MakeMeLaugh setOauthToken(java.lang.String oauthToken) {
      return (MakeMeLaugh) super.setOauthToken(oauthToken);
    }

    @Override
    public MakeMeLaugh setPrettyPrint(java.lang.Boolean prettyPrint) {
      return (MakeMeLaugh) super.setPrettyPrint(prettyPrint);
    }

    @Override
    public MakeMeLaugh setQuotaUser(java.lang.String quotaUser) {
      return (MakeMeLaugh) super.setQuotaUser(quotaUser);
    }

    @Override
    public MakeMeLaugh setUserIp(java.lang.String userIp) {
      return (MakeMeLaugh) super.setUserIp(userIp);
    }

    @Override
    public MakeMeLaugh set(String parameterName, Object value) {
      return (MakeMeLaugh) super.set(parameterName, value);
    }
  }
